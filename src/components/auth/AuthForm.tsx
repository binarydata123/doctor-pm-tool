      ...
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-xl border border-slate-200">
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-primary-600 rounded-2xl mb-4">
            <span className="text-2xl font-bold text-white">DPM</span>
          </div>
          <h1 className="text-3xl font-bold text-slate-900 mb-2">DPM-Tool</h1>
          <p className="text-slate-600">Patient & Case Management</p>
        </div>
          ...
          {(storedAdminInvite || storedInvite) && !emailOtpRequired && (
            <div className="p-4 bg-sky-50 border border-sky-200 rounded-lg">
              ...
              <p className="text-sm text-slate-600 mt-1">
                {storedAdminInvite
                  ? "Create an account with the invited email to join your admin's DPM-Tool workspace."
